...
private:
	...
	bool           operator == (const Downsampler2x8Avx <NC> &other) const;
	bool           operator != (const Downsampler2x8Avx <NC> &other) const;
